...
int main(int argc, char** argv)
{
  ...
  std::vector <std::vector<double> > cercle = gen_poi.generate_circle(__NB_POINTS_BASE_FOOTPRINT__, 0.6, 0.0, 0.0, 0.0, 0.0);
  ...
  std::vector <std::vector<double> > pathToFollow = gen_poi.generate_circle(__NB_POINTS_PATH__, 0.85, 0.0, 0.0, 0.0, 0.175);

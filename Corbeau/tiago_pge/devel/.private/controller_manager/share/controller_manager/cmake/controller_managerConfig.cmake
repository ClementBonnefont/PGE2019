...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/pge/tiago_pge/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/pge/tiago_pge/devel/.private/controller_manager)
  ...
  set(controller_manager_INSTALL_PREFIX /home/pge/tiago_pge/install)
...
if(NOT "/home/pge/tiago_pge/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/pge/tiago_pge/src/ros_control/controller_manager/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pge/tiago_pge/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pge/tiago_pge/devel/.private/controller_manager/lib;/home/pge/tiago_pge/devel/lib;/opt/ros/kinetic/lib)

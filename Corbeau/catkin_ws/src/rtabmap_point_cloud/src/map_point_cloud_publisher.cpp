...
float cloud_min_depth_ = 1;
float cloud_voxel_size_ = 0.05;

sensor_msgs::PointCloud2::Ptr cloud_map(new sensor_msgs::PointCloud2);
pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_map_pcl(new pcl::PointCloud<pcl::PointXYZRGB>);
...
{
	ros::init (argc, argv, "map_point_cloud_publisher");

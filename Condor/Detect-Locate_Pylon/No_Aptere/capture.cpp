...
int main(int argc, char **argv) {
	...
	if (zed.grab() == SUCCESS) {
		...
		imwrite("/home/jetson/Photo_ZED/Images/Left/Image_left_appro" + std::to_string(counter) + ".png", ocv_image_left);
		imwrite("/home/jetson/Photo_ZED/Images/Right/Image_right_appro" + std::to_string(counter) + ".png", ocv_image_right);
		imwrite("/home/jetson/Photo_ZED/Images/Depth/Depth_map_appro" + std::to_string(counter) + ".png", ocv_depth_map);
		std::cout << "/home/jetson/Photo_ZED/Images/Left/Image_left_appro" + std::to_string(counter) + ".png" << std::endl;
		
		// Write depth measure on disk
		cv::FileStorage storage("/home/jetson/Photo_ZED/DepthMeasure/Depth_measure_appro" + std::to_string(counter) + ".yml", cv::FileStorage::WRITE);
